...
<ul class="deal-clock lof-clock-{$product.id_product|intval}-detail list-inline">
	{if isset($product.js) && $product.js == 'unlimited'}<li class="lof-labelexpired">{l s='Unlimited' d='Shop.Theme.Global'}</li>{/if}
</ul>
{if isset($product.js) && $product.js != 'unlimited'}
	<script type="text/javascript">
		{literal}
		jQuery(document).ready(function($){{/literal}
			var text_d = '{l s='d' d='Shop.Theme.Global'}';
			var text_h = '{l s='h' d='Shop.Theme.Global'}';
			var text_m = '{l s='m' d='Shop.Theme.Global'}';
			var text_s = '{l s='s' d='Shop.Theme.Global'}';
